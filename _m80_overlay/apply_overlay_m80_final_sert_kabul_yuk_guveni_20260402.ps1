...
$backupRoot = Join-Path $RepoRoot ("_overlay_backup_m80_final_sert_kabul_yuk_guveni_" + $stamp)
New-Item -ItemType Directory -Force -Path $backupRoot | Out-Null

Write-Host ''
Write-Host '=== APPLY OVERLAY M80 FINAL SERT KABUL VE YUK GUVENI ==='
...
Write-Host '.\tools\pack_m79_copilot_acceptance.ps1 -RepoRoot D:\servis-platform'
