...
Assert-RepoContractContainsAny -Text $startpack -Needles @('M80 final sert kabul ve yuk guveni kapisi','pack_m80_final_sert_kabul_yuk_guveni') -Label 'startpack defines M80 gate'
...
Assert-RepoContractContainsAny -Text $toolsPrimer -Needles @('M80 pack komutu','resmi green degil') -Label 'tools primer mirrors M80 gate'
