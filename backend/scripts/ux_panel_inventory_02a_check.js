...
function main() {
  ...
  mustContains(audit, "125", "audit states total panel-related JSX file count");
  ...
  must(panelFiles.length === 125, "panel-related JSX count matches audit");
  ...
  assertProductExtensionsIncludes(
    ...
    "product extensions registry keeps UX-COLLAPSIBLE-PANELS-01",
    registryScripts
  );
