...
function statusFromPackage(pkg, name) {
  if (pkg === "root") {
    if (["check", "verify:repo", "verify:ci", "verify:closure", "verify:final", "check:product-extensions", "check:verifychain01", "check:scriptharnessconsolidation01"].includes(name)) {
      return "ACTIVE_CORE";
    }
...
const coverageMatrix = [
  ...
  },
  {
    ...
    frontendSurface: "web/src/panels/company/OperationsPanel.jsx; ShiftsPanel.jsx; AgreementsPanel.jsx; AgreementWizard.jsx; CommercialFlowPanel.jsx; ServiceEvaluationPanel.jsx; MapPanel.jsx; WorkflowPanel.jsx; PersonelAccessPanel.jsx; PassengerLinksPanel.jsx; HubPanel.jsx; CompanyShiftsPanel*",
    currentCheckScript: "check:uxcompanyopspaneltabs01; check:uxcompanyqualitytabs01; check:uxcompanypanelsfinalpolish01; check:uxcompanypanelssmoke01; check:routechangefinal01; check:boardingops01b; check:boardingops01c",
    checkType: "static + manual boundary",
    coverageStatus: "COVERED_ACTIVE",
    missingGap: "None on the current static/product chain.",
  ...
  },
  {
    ...
    currentCheckScript: "check:cop04bfix08; check:m98e2d; check:finaluxsmoke01",
  ...
  },
  {
    ...
    currentCheckScript: "check:cop04bfix03; check:copliveaccept01; check:m98e2b; check:finaluxsmoke01",
    checkType: "static + auth-session",
    coverageStatus: "COVERED_ACTIVE",
    missingGap: "No browser/mobile end-to-end acceptance path yet.",
