...
function slugToMilestone(slug) {
  ...
  [/uxpremiumcriticaluxfixcleanup0?1/i, "UX-PREMIUM-CRITICAL-UXFIX-CLEANUP-01"],
    ...
    [/audit[_-]?log[_-]?and[_-]?approval[_-]?trace[_-]?0?1(?:[_-]?check)?/i, "AUDIT-LOG-AND-APPROVAL-TRACE-01"], // check:auditlogandapprovaltrace01
    ...
    [/backend[_-]?lint[_-]?warning[_-]?burndown[_-]?01(?:[_-]?check)?/i, "BACKEND-LINT-WARNING-BURNDOWN-01"], // check:backendlintwarningburndown01
    [/requeststormresilience0?1/i, "REQUEST-STORM-RESILIENCE-01"], // check:requeststormresilience01
    [/role[_-]?data[_-]?isolation[_-]?redteam[_-]?0?1(?:[_-]?check)?/i, "ROLE-DATA-ISOLATION-REDTEAM-01"], // check:roledataisolationredteam01
...
function buildDoc(summary, packageEntries, fileEntries, oldSystemHits) {
  ...
  out.push(`- Cache coalescing and backoff milestone: \`CACHE-COALESCING-AND-BACKOFF-01\``);
  out.push(`- Cache coalescing and backoff alias: \`check:cachecoalescingandbackoff01\``);
  out.push(`- Cache coalescing and backoff docs: \`docs/CACHE_COALESCING_AND_BACKOFF_01.md\``);
  out.push(`- Cache coalescing and backoff command: \`node backend\\scripts\\cache_coalescing_and_backoff_01_check.js\``);
  ...
  out.push(`- Backend lint warning burndown milestone: \`BACKEND-LINT-WARNING-BURNDOWN-01\``);
  ...
  out.push(`- Role data isolation redteam milestone: \`ROLE-DATA-ISOLATION-REDTEAM-01\``);
  ...
  out.push(`- Audit trace milestone: \`AUDIT-LOG-AND-APPROVAL-TRACE-01\``);
  out.push(`- Audit trace alias: \`check:auditlogandapprovaltrace01\``);
  out.push(`- Audit trace docs: \`docs/AUDIT_LOG_AND_APPROVAL_TRACE_01.md\``);
  out.push(`- Audit trace command: \`node backend\\scripts\\audit_log_and_approval_trace_01_check.js\``);
  ...
  out.push(`- Negotiation assist milestone: \`COPILOT-NEGOTIATION-ASSIST-01\``);
  out.push(`- Negotiation assist check: \`check:copilotnegotiationassist01\``);
  out.push(`- Negotiation assist docs: \`docs/COPILOT_NEGOTIATION_ASSIST_01.md\``);
  out.push(`- Negotiation assist command: \`node backend\\scripts\\copilot_negotiation_assist_01_check.js\``);
  out.push(`- Negotiation assist helper: \`backend/src/ai/chat/copilotNegotiationAssist.js\``);
  out.push(`- Negotiation assist root check: \`root:check:copilotnegotiationassist01\``);
  out.push(`- Offer recommendation milestone: \`COPILOT-OFFER-RECOMMENDATION-01\``);
  out.push(`- Offer recommendation check: \`check:copilotofferrecommendation01\``);
  out.push(`- Offer recommendation docs: \`docs/COPILOT_OFFER_RECOMMENDATION_01.md\``);
  ...
  out.push(`- Dispatch action prep milestone: \`COPILOT-DISPATCH-ACTION-PREP-01\``);
  out.push(`- Dispatch action prep check: \`check:copilotdispatchactionprep01\``);
  out.push(`- Dispatch action prep root check: \`root:check:copilotdispatchactionprep01\``);
  out.push(`- Dispatch action prep docs: \`docs/COPILOT_DISPATCH_ACTION_PREP_01.md\``);
  out.push(`- Dispatch action prep command: \`node backend\\scripts\\copilot_dispatch_action_prep_01_check.js\``);
  out.push(`- Dispatch action prep helper: \`backend/src/ai/chat/copilotDispatchActionPrep.js\``);
  out.push(`- Financial operations surface milestone: \`FINANCIAL-OPERATIONS-SURFACE-AND-RBAC-01\``);
  out.push(`- Financial operations surface check: \`check:financialoperationssurfaceandrbac01\``);
  out.push(`- Financial operations surface root check: \`root:check:financialoperationssurfaceandrbac01\``);
  ...
  out.push(`- Room profitability milestone: \`ROOM-PROFITABILITY-AND-QUOTE-FLOOR-01\``);
  out.push(`- Room profitability check: \`check:roomprofitabilityandquotefloor01\``);
  out.push(`- Room profitability root check: \`root:check:roomprofitabilityandquotefloor01\``);
  out.push(`- Room profitability docs: \`docs/ROOM_PROFITABILITY_AND_QUOTE_FLOOR_01.md\``);
...
function verifyDoc(docText, summary) {
  const mustContain = [
    ...
    "Offer recommendation milestone",
    "Offer recommendation check",
    "Offer recommendation docs",
  ...
  "UX-MOBILE-OVERFLOW-MINIMAP-READABILITY-01",
    ...
    "root:check:roomprofitabilityandquotefloor01",
    "docs/ROOM_PROFITABILITY_AND_QUOTE_FLOOR_01.md",
