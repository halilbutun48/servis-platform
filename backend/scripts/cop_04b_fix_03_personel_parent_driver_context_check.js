...
must(helpComposerSource, 'GPS/operasyon kanıtını kontrol et', 'help composer keeps driver operational chip');
...
must(factsSource, 'Araç GPS’i', 'facts keeps vehicle gps wording');
...
mustArrayContains(chipList(personelResponse), "Sürücünün telefon GPS’i devrede mi?", 'personel chips keep phone gps chip');
...
mustArrayContains(chipList(driverResponse), 'GPS/operasyon kanıtını kontrol et', 'driver chips keep proof chip');
