...
function main() {
  ...
  const runtimeCases = [
    ...
    },
    {
      ...
      replyAnyOf: [['GPS', 'sürücü', 'son konum']],
      chipsIncludes: ['GPS', 'Sürücü', 'Son konum'],
    },
    {
    ...
    },
    {
      ...
      fixture: roomVehiclesFixture,
      message: 'Görünmüyor.',
      replyIncludes: ['Seçili araç', 'GPS', 'sürücü'],
      replyAnyOf: [['son konum', 'durak']],
      chipsIncludes: ['GPS', 'Sürücü', 'Son konum', 'Durak'],
    },
    {
      ...
      replyIncludes: ['servis görünmüyorsa', 'son GPS', 'araç bağlantısı'],
      replyExcludes: ['Netleştirelim'],
    ...
    },
    {
      ...
      message: 'Görünmüyor.',
      expectedQuestionTypes: ['LOCATION_HELP', 'SCREEN_PURPOSE'],
      replyIncludes: ['Personel Canlı ekranında', 'servis kaydı', 'son GPS', 'araç bağlantısı', 'durak'],
      replyExcludes: ['Netleştirelim'],
      chipsIncludes: ['Servis', 'Araç', 'Durak', 'Saat'],
    },
    {
