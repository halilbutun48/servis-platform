...
must(answerPolicySource, 'Sürücünün telefon GPS’i devrede mi?', 'answer policy keeps phone gps chip');
...
mustArrayContains(chipsB, 'Son GPS ne zaman geldi?', 'fixture B chips keep last gps chip');
mustArrayContains(chipsB, 'Sürücünün telefon GPS’i devrede mi?', 'fixture B chips keep phone gps chip');
