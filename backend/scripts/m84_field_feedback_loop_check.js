...
mustInclude(roleNavigation, '{ label: "Geri Bildirim", path: "/shared/feedback" }', "role navigation exposes feedback under advanced");
...
mustNotInclude(navDock, "copilotSection", "navdock keeps Sefer Abi out of primary navigation sections");
