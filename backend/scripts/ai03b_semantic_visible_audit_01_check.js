...
function main() {
  ...
  const visibleCases = [
    ...
    },
    {
      ...
      expectedReasoningFamily: 'SCREEN_START',
      replyNeedles: ['hizmet alan firma konumu', 'rota önizlemesine bak', 'Vardiyalar ekranında takip et'],
    ...
    },
    {
      ...
      expectedReasoningFamily: 'SCREEN_START',
      replyNeedles: ['SeferPakt', 'Hizmet Alan Firma rolünde', 'Planlama Merkezi'],
      replyNotNeedles: ['Sıradaki doğru işlem'],
      expectedNormalizedIntent: null,
      expectedNormalizedEntityType: null,
    },
    ...
    },
    {
      ...
      expectedQuestionType: 'RISK_LIST',
      expectedReasoningFamily: 'DEFAULT',
      replyNeedles: ['Taşımacılık Firması açısından', 'riskli alanı belirle', 'Sonra ilgili ekrana geç'],
      payloadQuestionType: 'RISK_LIST',
      payloadChips: ['Konum riski', 'Tarih / saat riski', 'Personel açığı', 'Rota önizleme riski'],
      expectedNormalizedIntent: null,
      expectedNormalizedEntityType: null,
  ...
  const typedParityCases = [
    ...
    },
    {
      ...
      replyNeedles: ['Bu rota için gerçek uygulama başlatamam', 'Onayınız gerekli', 'preview ve risk özeti'],
    },
    {
    ...
    },
    {
      ...
      message: 'Konum riski',
      expectedQuestionType: 'ROUTE_REVIEW_HUMAN_APPROVAL',
      replyNeedles: ['Bu rota için gerçek uygulama başlatamam', 'risk özeti', 'Onayınız gerekli', 'preview'],
    },
    {
    ...
    },
    {
      ...
      replyNeedles: ['DB write', 'personel oluşturma', 'eksik kolonlar', 'KVKK sınırını'],
    },
    {
