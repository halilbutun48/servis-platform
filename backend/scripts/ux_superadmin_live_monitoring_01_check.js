...
function main() {
  ...
  must(panel, "Konum sinyali güveni", "top metric location signal safety");
  must(panel, "Kalite kontrolü giriş kaydı", "top metric quality-control entry");
  ...
  must(panel, "Geçmiş / İşlem kayıtları", "history tab label");
  ...
  must(panel, "İşlenemeyen kayıt geçmişi", "history unprocessed-record section");
  must(panel, "Geçmiş / İşlem kayıtları", "history title");
  ...
  must(panel, "İşlem kaydı özeti", "history summary card");
