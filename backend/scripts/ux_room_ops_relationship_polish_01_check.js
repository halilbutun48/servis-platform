...
function main() {
  ...
  mustContains(hubVisible, "Oda Konumu", "Hub UI shows room-specific Konum label");
  mustContains(hubVisible, "Şirket Konumu", "Hub UI shows company-specific Konum label");
  ...
  mustContains(hubVisible, "Kurum planı markete gönderime hazır", "Hub UI shows organization readiness headline");
  mustContains(hubVisible, "Kurum planı henüz tam değil", "Hub UI shows organization blocking headline");
  mustContains(hubVisible, "Tüm konumlar koordinatlı", "Hub UI shows organization Konum readiness copy");
  mustContains(hubVisible, "Kurum işlerinde plan tam oluşmadan markete düşmez.", "Hub UI shows organization readiness note");
  mustContains(hubVisible, "Şirket konumu koordinat olarak hazır", "Hub UI shows company readiness headline");
  mustContains(hubVisible, "Şirket konumu henüz tam değil", "Hub UI shows company blocking headline");
  mustContains(hubVisible, "Toplanma konumu kaydedildi.", "Hub UI shows translated save feedback");
  mustContains(hubVisible, "Şirket konumu kaydedildi.", "Hub UI shows translated company save feedback");
