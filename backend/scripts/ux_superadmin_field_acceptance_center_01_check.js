...
must(includes(panel, "TabPanel active={activeTab === \"manifest\"} label=\"Varsayılanlar\""), "manifest tab exists");
...
must(includes(panel, "TabPanel active={activeTab === \"checklist\"} label=\"Kontrol listesi güncelleme\""), "checklist tab exists");
must(includes(panel, "TabPanel active={activeTab === \"history\"} label=\"Geçmiş / İşlem kayıtları\""), "history tab exists");
...
must(includes(panel, "Kontrol listesi güncelleme"), "checklist update section preserved");
...
must(includes(panel, "Varsayılanlar: karar seçenekleri"), "manifest decision section preserved");
must(includes(panel, "Varsayılanlar: kontrol listesi özeti"), "manifest checklist section preserved");
must(includes(panel, "Oturum kaynağı"), "manifest provenance section preserved");
must(includes(panel, "Varsayılan kanıt türleri"), "manifest evidence types section preserved");
