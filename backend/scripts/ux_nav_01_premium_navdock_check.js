...
const appSource = read('web/src/App.jsx');
  ...
  must(navDockSource, 'advanced.push({ label: "Hub", path: base + "/hub" });', 'company system items move into advanced section');
  ...
  must(navDockSource, 'Lokasyon İncele', 'nav dock keeps organization location item visible');
  must(navDockSource, 'Hub', 'nav dock keeps system hub item visible');
