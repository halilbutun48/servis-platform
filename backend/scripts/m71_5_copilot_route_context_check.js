...
if (has(copilot, 'setChatScreenId(String(match.id));') && has(copilot, '}, [hashPath, screenOptionsFromMe]);')) ok('CopilotPanel syncs chat screen on route change'); else fail('CopilotPanel syncs chat screen on route change');
