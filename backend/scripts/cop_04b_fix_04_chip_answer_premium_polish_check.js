...
must(answerPolicySource, 'Stale/offline satırını aç', 'answer policy keeps stale chip');
...
mustArrayContains(roomOperationChips, 'Stale/offline satırını aç', 'operation health chips keep stale chip');
