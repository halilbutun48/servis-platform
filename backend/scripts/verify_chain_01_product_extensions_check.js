...
function main() {
  ...
  must(pkg, '"check:copilotrfqprep01": "node backend/scripts/copilot_rfq_prep_01_check.js"', 'package.json exposes check:copilotrfqprep01');
  ...
  must(guide, 'COPILOT-RFQ-PREP-01', 'script guide mentions RFQ prep milestone');
  must(guide, 'check:copilotrfqprep01', 'script guide exposes RFQ prep check');
  ...
  must(guide, 'COPILOT-DISPATCH-ACTION-PREP-01', 'script guide mentions dispatch prep milestone');
  must(guide, 'check:copilotdispatchactionprep01', 'script guide exposes dispatch prep check');
  ...
  must(harnessCheck, 'check:copilotnegotiationassist01', 'script harness check knows negotiation assist alias');
  must(harnessCheck, 'copilot_negotiation_assist_01_check.js', 'script harness check knows negotiation assist file');
  must(harnessCheck, 'COPILOT-NEGOTIATION-ASSIST-01', 'script harness check knows negotiation assist milestone');
  must(harnessCheck, 'docs/COPILOT_NEGOTIATION_ASSIST_01.md', 'script harness check knows negotiation assist doc');
  must(harnessCheck, 'backend/src/ai/chat/copilotNegotiationAssist.js', 'script harness check knows negotiation assist helper');
  ...
  must(harnessDoc, 'root:check:copilotnegotiationassist01', 'script harness doc lists negotiation assist root check');
  must(harnessDoc, 'copilot_negotiation_assist_01_check.js', 'script harness doc lists negotiation assist check');
  must(harnessDoc, 'docs/COPILOT_NEGOTIATION_ASSIST_01.md', 'script harness doc lists negotiation assist doc');
  must(harnessDoc, 'COPILOT-NEGOTIATION-ASSIST-01', 'script harness doc lists negotiation assist milestone');
  must(harnessDoc, 'backend/src/ai/chat/copilotNegotiationAssist.js', 'script harness doc lists negotiation assist helper');
  ...
  must(harnessDoc, 'Dispatch action prep milestone: `COPILOT-DISPATCH-ACTION-PREP-01`', 'script harness doc lists dispatch prep milestone');
  must(harnessDoc, 'check:copilotdispatchactionprep01', 'script harness doc lists dispatch prep check');
  ...
  must(roadmap, 'COPILOT-RFQ-PREP-01', 'roadmap keeps RFQ prep milestone');
  must(roadmap, 'draft-only RFQ prep companion milestone', 'roadmap keeps RFQ prep wording');
  ...
  must(roadmap, 'COPILOT-DISPATCH-ACTION-PREP-01', 'roadmap keeps dispatch prep milestone');
  ...
  must(negotiationAssistDoc, 'COPILOT-NEGOTIATION-ASSIST-01', 'negotiation assist doc keeps milestone wording');
  must(negotiationAssistDoc, 'check:copilotnegotiationassist01', 'negotiation assist doc keeps canonical check wording');
  must(negotiationAssistHelper, 'COPILOT_NEGOTIATION_ASSIST_VERSION', 'negotiation assist helper exports version');
  must(negotiationAssistHelper, 'COPILOT_NEGOTIATION_ASSIST_PUBLIC_PROMISE', 'negotiation assist helper exports public promise');
  must(offerRecommendationDoc, 'COPILOT-OFFER-RECOMMENDATION-01', 'offer recommendation doc keeps milestone wording');
  must(offerRecommendationDoc, 'check:copilotofferrecommendation01', 'offer recommendation doc keeps canonical check wording');
  ...
  must(dispatchActionPrepDoc, '# COPILOT DISPATCH ACTION PREP 01', 'dispatch doc title present');
  must(dispatchActionPrepDoc, 'Canonical check: `check:copilotdispatchactionprep01`', 'dispatch doc keeps canonical check wording');
  must(dispatchActionPrepCheck, '=== COPILOT-DISPATCH-ACTION-PREP-01 CHECK ===', 'dispatch prep check script banner present');
  ...
  must(demandToAgreementDoc, 'COPILOT-DISPATCH-ACTION-PREP-01', 'demand-to-agreement doc references dispatch prep companion');
  must(demandToAgreementDoc, 'check:copilotdispatchactionprep01', 'demand-to-agreement doc exposes dispatch prep check');
  must(demandToAgreementDoc, 'docs/COPILOT_DISPATCH_ACTION_PREP_01.md', 'demand-to-agreement doc links dispatch prep doc');
  must(demandToAgreementDoc, 'backend/src/ai/chat/copilotDispatchActionPrep.js', 'demand-to-agreement doc links dispatch prep helper');
