...
function main() {
  ...
  assertProductExtensionsIncludes('check:seferscore01', 'product extensions registry includes sefer score check', registryScripts);
  assertProductExtensionsOrder(registryScripts, 'product extensions registry order', registryScripts);
  must(runner, 'import { productExtensionsChecks } from "./lib/productExtensionsRegistry.js";', 'product extensions runner imports structured registry');
  must(runner, 'runStructuredScriptChain(productExtensionsChecks', 'product extensions runner executes structured registry');
  mustNot(runner, 'productExtensionsCheckScripts = Object.freeze([', 'product extensions runner does not duplicate literal inventory');
