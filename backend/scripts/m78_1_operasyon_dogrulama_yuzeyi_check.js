...
mustContain(nav, 'getRoleNavigation', 'nav delegates to canonical role navigation');
mustContain(roleNavigation, 'Operasyon Doğrulama', 'role navigation has operation verification item');
