...
must(servicePanel, "quality-summary-grid", "service panel keeps summary grid");
must(servicePanel, "quality-detail-layout", "service panel keeps detail layout");
must(servicePanel, "quality-card-shell", "service panel keeps quality card shell");
must(servicePanel, "quality-metric-grid", "service panel keeps metric grid");
