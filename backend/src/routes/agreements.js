...
const SOURCE_SHIFT_AGREEMENT_BLOCKING_STATUSES = ["REQUESTED", "COUNTERED", "APPROVED", "ACTIVE", "DONE"];

async function findBlockingAgreementForSourceShift(tx, { sourceShiftId, companyId, roomId }) {
