...
export const ENV = {
  ...
  // Step-up / provider toggle
  // 0 = disable all step-up checks, 1 = enable step-up checks, empty = mode-aware default
  STEP_UP_ENABLED: process.env.STEP_UP_ENABLED ?? "",
  STEP_UP_PROVIDER: process.env.STEP_UP_PROVIDER ?? "",
  STEP_UP_REQUIRED_ROLES: process.env.STEP_UP_REQUIRED_ROLES ?? "SUPER_ADMIN,ROOM,COMPANY",
  STEP_UP_TOTP_ENABLED: (process.env.STEP_UP_TOTP_ENABLED ?? (IS_PRODUCTION ? "1" : "0")) === "1",
  ...
  // M93: auto-reached queue durability guardrails
  AUTO_REACHED_LOCK_TTL_MS: Number(process.env.AUTO_REACHED_LOCK_TTL_MS ?? 2 * 60 * 1000),
  AUTO_REACHED_PROCESSING_TTL_MS: Number(process.env.AUTO_REACHED_PROCESSING_TTL_MS ?? 5 * 60 * 1000),
  AUTO_REACHED_RECLAIM_SWEEP_MS: Number(process.env.AUTO_REACHED_RECLAIM_SWEEP_MS ?? 60 * 1000),
  AUTO_REACHED_MAX_ATTEMPTS: Number(process.env.AUTO_REACHED_MAX_ATTEMPTS ?? 3),
  AUTO_REACHED_QUEUE_DEPTH_WARN: Number(process.env.AUTO_REACHED_QUEUE_DEPTH_WARN ?? 500),
  AUTO_REACHED_PROCESSING_DEPTH_WARN: Number(process.env.AUTO_REACHED_PROCESSING_DEPTH_WARN ?? 50),
  AUTO_REACHED_CLAIMS_DEPTH_WARN: Number(process.env.AUTO_REACHED_CLAIMS_DEPTH_WARN ?? 50),
  AUTO_REACHED_DEAD_LETTER_DEPTH_WARN: Number(process.env.AUTO_REACHED_DEAD_LETTER_DEPTH_WARN ?? 1),
  AUTO_REACHED_OLDEST_CLAIM_AGE_MS_WARN: Number(process.env.AUTO_REACHED_OLDEST_CLAIM_AGE_MS_WARN ?? 120000),
