...
export const ROOM = [
  screen(1101, "/room/map", "Canlı Takip", {
    ...
    dataRules: ["Son konum bilgisi çok eskiyse bu ekran tek başına canlı karar için yeterli değildir.", "Üst karttaki durum, sıradaki durak ve tahmini varış süresi birlikte okunmalıdır; tek rozetle karar verilmez.", "Haritadaki mavi aktif parça sıradaki hedefi, yeşil parça geçilen kısmı gösterir.", "Araç seçili değilse üst özet değişmez; önce doğru araç satırını seç."],
    firstControls: ["Önce doğru aracı veya seçili işi seç.", "Son konum bilgisi zamanı yeni mi kontrol et.", "Shift durumu, sıradaki durak ve tahmini varış süresi birlikte tutarlı mı bak."],
    stuckChecks: ["Araç seçili değilse üst kart değişmez.", "Son konum bilgisi eskiyse canlı karar verme.", "Haritada araç var ama üst kart boşsa doğru vardiya bağını kontrol et."],
    workflowStages: [
      ...
      { key: 'ROOM_MAP_READ', title: 'Canlı bilgiyi oku', action: 'Konum sinyali, son konum bilgisi, sıradaki durak ve tahmini varış süresi alanlarını birlikte oku.', doneWhen: 'Canlı durum hakkında tek cümlelik özet çıkarabiliyorsun.', ifBlocked: 'Son konum bilgisi çok eskiyse bu ekran tek başına karar için yetmez.' },
    ...
    chatQuestions: ['Bu araç neden haritada görünmüyor?', 'Son konum bilgisi ne zaman geldi?', 'Sürücünün telefon GPS’i devrede mi?', 'Sürücünün telefonundan konum sinyali geliyor mu?', 'Araç bağlantısı var mı?'],
    fieldGuides: [
      ...
      { label: 'Konum sinyali', meaning: 'Araçtan canlı konum akıp akmadığını özetler.', howToRead: 'ONLINE/OFFLINE bilgisini son konum bilgisi ile birlikte değerlendir.' },
      { label: 'Son konum bilgisi', meaning: 'En son konumun ne kadar önce geldiğini gösterir.', risk: 'Çok eskiyse sahadaki canlı durumu tek başına temsil etmez.' },
      { label: 'Sıradaki durak', meaning: 'Araç için bir sonraki hedef noktadır.' },
      { label: 'Tahmini varış süresi', meaning: 'Sıradaki durağa tahmini kalan süredir.' },
    ...
    badgeGuides: [
      ...
      { label: 'OFFLINE', meaning: 'Son anda canlı konum sinyali görünmüyor olabilir.', actionHint: 'Son konum bilgisi ve telefon tarafını kontrol et.' },
      { label: 'ONLINE', meaning: 'Canlı konum sinyali görülüyor.' },
    ],
    rowReadHint: 'Önce plaka ve shift durumunu oku. Sonra konum sinyali, son konum bilgisi ve tahmini varış süresi alanlarını birlikte değerlendir. En son toplam, tamamlanan ve kalan ile rotanın neresinde olduğunu anla.',
  }),
  ...
  screen(1114, "/room/operation-health", "Operasyon Sağlığı", {
    ...
    dataRules: ["Açık sorun sayısı sıfır değilse ekran yalnız bilgilendirme değil aksiyon ekranıdır.", "Konum bilgisi güncel değil / çevrim dışı sayısı ile riskli cihaz sayısı birlikte okunmalıdır."],
    ...
    chatQuestions: ['Operasyon Sağlığı: sorun ne?', 'Riskli cihazı göster', 'Konum bilgisi güncel değil / çevrim dışı satırını aç', 'Açık sorunları sırala'],
  }),
...
export const COMPANY = [
  ...
  screen(2112, "/company/map", "Canlı Harita", {
    ...
    stepByStep: ["Doğru aracı seç.", "Son konum bilgisi, sıradaki durak ve tahmini varış süresi bilgisini birlikte oku.", "Gerekirse Vardiyalar ekranına geç."],
    commonMistakes: ["Haritadaki tek rozetle karar vermek.", "Mavi, yeşil ve tam rota çizgilerini aynı şey sanmak."],
    doneChecklist: ["Doğru araç seçildi.", "Canlı özet ve tahmini varış süresi birlikte okundu."],
    buttonGuides: [
    ...
    simpleTerms: pickTerms(["telefonGps", "cihazGps", "konumKaynagi"]),
    dataRules: ["Son konum bilgisi çok eskiyse bu ekran tek başına canlı karar için yetmez.", "Sıradaki durak, tahmini varış süresi ve kalan durak sayısı birlikte okunmalıdır.", "Mavi aktif parça sıradaki hedefi, yeşil parça geçilen kısmı gösterir; tam rota tabanı ayrı görülebilir.", "Araç seçili değilse üst kart ve Copilot bağlamı doğru değişmez; önce doğru satırı seç."],
    firstControls: ["Önce doğru aracı seç.", "Son konum bilgisi zamanı yeni mi kontrol et.", "Sıradaki durak ve tahmini varış süresi mantıklı mı bak."],
    stuckChecks: ["Araç seçili değilse üst kart değişmez.", "GPS eskiyse canlı karar verme.", "Harita var ama tahmini varış süresi sabitse rota yenileme zincirini kontrol et."],
    workflowStages: [
      ...
      { key: 'COMPANY_MAP_READ', title: 'Canlı özeti oku', action: 'Son konum bilgisi, sıradaki durak, tahmini varış süresi ve kalan durak bilgisini birlikte değerlendir.', doneWhen: 'Canlı durumu tek cümlede özetleyebilirsin.', ifBlocked: 'Konum bilgisi çok eskiyse vardiya ekranına in.' },
    ...
    nextScreens: [
      ...
      { label: 'Copilot', path: '/company/copilot', reason: 'Canlılık, tahmini varış süresi ve seçili kayıt sorularını adım adım sormak için.' },
    ],
    ...
    fieldGuides: [
      ...
      { label: 'Son konum bilgisi', meaning: 'Canlı konum bilgisinin ne kadar önce geldiğini gösterir.', risk: 'Çok eskiyse canlı karar vermek yanıltıcı olabilir.' },
      { label: 'Sıradaki Durak', meaning: 'Aracın bir sonraki hedef noktasıdır.' },
      { label: 'Tahmini varış süresi', meaning: 'Sıradaki durağa tahmini kalan süredir.', risk: 'Sabit kalıyorsa rota güncellenmiyor olabilir.' },
    ...
    badgeGuides: [
      ...
      { label: 'ONLINE', meaning: 'Canlı konum sinyali var.' },
      { label: 'OFFLINE', meaning: 'Canlı konum akışı görünmüyor veya düşmüş olabilir.', actionHint: 'Son konum bilgisi zamanını ve cihaz/telefon tarafını kontrol et.' },
    ],
    rowReadHint: 'Önce araç alanını doğrula. Sonra son konum bilgisi, sıradaki durak ve tahmini varış süresi alanlarını birlikte oku. En son toplam ve kalan durak ile işin rotadaki konumunu anla.',
  }),
