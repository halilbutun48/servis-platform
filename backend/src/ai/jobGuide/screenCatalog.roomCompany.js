...
export const ROOM = [
  screen(1101, "/room/map", "Canlı Takip", {
    ...
    firstControls: ["Önce doğru aracı veya seçili işi seç.", "Son GPS zamanı yeni mi kontrol et.", "Shift durumu, sıradaki durak ve tahmini varış süresi birlikte tutarlı mı bak."],
    ...
    workflowStages: [
      ...
      { key: 'ROOM_MAP_READ', title: 'Canlı bilgiyi oku', action: 'GPS, son GPS, sıradaki durak ve tahmini varış süresi alanlarını birlikte oku.', doneWhen: 'Canlı durum hakkında tek cümlelik özet çıkarabiliyorsun.', ifBlocked: 'Son GPS çok eskiyse bu ekran tek başına karar için yetmez.' },
    ...
    rowReadHint: 'Önce plaka ve shift durumunu oku. Sonra GPS, son GPS ve tahmini varış süresi alanlarını birlikte değerlendir. En son toplam, tamamlanan ve kalan ile rotanın neresinde olduğunu anla.',
  }),
...
export const COMPANY = [
  ...
  screen(2112, "/company/map", "Canlı Harita", {
    ...
    stepByStep: ["Doğru aracı seç.", "Son GPS, sıradaki durak ve tahmini varış süresi bilgisini birlikte oku.", "Gerekirse Vardiyalar ekranına geç."],
    ...
    firstControls: ["Önce doğru aracı seç.", "Son GPS zamanı yeni mi kontrol et.", "Sıradaki durak ve tahmini varış süresi mantıklı mı bak."],
    ...
    workflowStages: [
      ...
      { key: 'COMPANY_MAP_READ', title: 'Canlı özeti oku', action: 'Son GPS, sıradaki durak, tahmini varış süresi ve kalan durak bilgisini birlikte değerlendir.', doneWhen: 'Canlı durumu tek cümlede özetleyebilirsin.', ifBlocked: 'GPS çok eskiyse vardiya ekranına in.' },
    ...
    rowReadHint: 'Önce araç alanını doğrula. Sonra Son GPS, Sıradaki Durak ve tahmini varış süresi alanlarını birlikte oku. En son toplam ve kalan durak ile işin rotadaki konumunu anla.',
  }),
