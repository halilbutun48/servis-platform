...
const DRIVER = [
  ...
  screen(3103, '/driver/map', 'Harita', {
    ...
    firstControls: ['Önce konum güncel mi bak.', 'Sıradaki durak, mesafe ve tahmini varış süresi değişiyor mu kontrol et.', 'Ekran kapanınca canlılık sürüyor mu test et.'],
    stuckChecks: ['Harita var ama konum akmıyorsa background GPS izni veya yayın zinciri düşmüş olabilir.', 'Tahmini varış süresi sabit kalıyorsa rota tekrar çekilmiyor olabilir.', 'Auto reached çalışmıyorsa mesafe eşiği veya aktif görev bağını kontrol et.'],
    workflowStages: [
      ...
      { key: 'DRIVER_MAP_STOP', title: 'Durak otomasyonunu izle', action: 'Sıradaki durak, mesafe ve auto reached davranışını takip et.', doneWhen: 'Durak gelince reached olur ve sonraki durak bilgisi güncellenir.', ifBlocked: 'Tahmini varış süresi veya mesafe değişmiyorsa rota refresh zincirini kontrol et.' },
      { key: 'DRIVER_MAP_VOICE', title: 'Sesli desteği doğrula', action: 'Durak yaklaşınca alınacak yolcu sayısı ve sonraki durak tahmini varış süresinin okunup okunmadığını dinle.', doneWhen: 'Sesli destek operasyonu gerçekten yönlendirir.', ifBlocked: 'Sesli destek yalnız ön planda çalışıyorsa cihaz güç yönetimini ve speech akışını kontrol et.' },
    ],
    nextScreens: [
      { label: 'Bugün', path: '/driver/today', reason: 'Görev özetine dönmek için.' },
      { label: 'Copilot', path: '/driver/copilot', reason: 'Canlılık veya tahmini varış süresi sorununu adım adım teşhis etmek için.' },
    ],
  ...
  screen(3105, '/driver/copilot', 'Copilot', {
    ...
    nextScreens: [
      { label: 'Bugün', path: '/driver/today', reason: 'Görev özetine dönmek için.' },
      { label: 'Harita', path: '/driver/map', reason: 'Canlılık, tahmini varış süresi ve rota takibi için.' },
