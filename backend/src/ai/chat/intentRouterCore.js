...
export function isRiskListQuestion(text) {
  ...
  return matchesStandalonePhrase(value, [
    ...
    'öncelik ne',
    'oncelik ne',
    'önce hangi riske bakayım',
    'once hangi riske bakayim',
    'hangi konu acil',
    'operasyon riski ne',
    'saha riski ne',
    'maliyet riski var mı',
    'maliyet riski var mi',
    'gecikme riski var mı',
    'gecikme riski var mi',
    'gps riski var mı',
    'gps riski var mi',
    'kapasite riski var mı',
    'kapasite riski var mi',
    'atama riski var mı',
    'atama riski var mi',
    'sözleşme riski var mı',
    'sozlesme riski var mi',
    'teklif riski var mı',
    'teklif riski var mi',
  ]);
}
...
export const BASE_RULES = [
  ...
  { type: 'RISK_LIST', score: 10, patterns: ['riskleri sırala', 'riskleri sirala', 'risk listesi', 'başlıca riskler', 'baslica riskler', 'en büyük riskler', 'en buyuk riskler', 'risk var mı', 'risk var mi', 'riskli mi', 'en riskli ne', 'en kritik ne', 'hangisi daha riskli', 'öncelik ne', 'oncelik ne', 'önce hangi riske bakayım', 'once hangi riske bakayim', 'hangi konu acil', 'operasyon riski ne', 'saha riski ne', 'maliyet riski var mı', 'maliyet riski var mi', 'gecikme riski var mı', 'gecikme riski var mi', 'gps riski var mı', 'gps riski var mi', 'kapasite riski var mı', 'kapasite riski var mi', 'atama riski var mı', 'atama riski var mi', 'sözleşme riski var mı', 'sozlesme riski var mi', 'teklif riski var mı', 'teklif riski var mi'], label: 'risk-list' },
