...
const DIAGNOSTIC_TEMPLATES = {
  ...
  COMPANY_OPERATIONS_LIVE_MISSING: { lead: templateLead('Canlı durum için aktif servis/vardiya, araç ataması ve konum sinyali verisi gerekir.'), next: templateLead('Önce aktif operasyon var mı, sonra araç konum sinyali durumu geliyor mu kontrol edelim.'), chips: templateChipList(['Aktif operasyon', 'Araç konum sinyali', 'Tarih filtresi', 'Şirket bağlamı']) },
  ...
  COMPANY_OPERATIONS_GPS_MISSING: { lead: templateLead('Araç haritada yoksa ya konum sinyali gelmiyordur ya da araç kayıt / bağlantı eksiktir.'), next: templateLead('Önce araç atamasını ve son konum zamanını kontrol edelim.'), chips: templateChipList(['Araç ataması', 'Son konum zamanı', 'Konum sinyali durumu', 'Harita']) },
  ...
  COMPANY_OFFERS_MISSING: { lead: templateLead('Teklif görünmüyorsa talep henüz gönderilmemiş, tedarikçiden dönüş gelmemiş veya filtre / durum farklı olabilir.'), next: templateLead('Önce talep durumu ve teklif filtresini kontrol edelim.'), chips: templateChipList(['Talep durumu', 'Teklif filtresi', 'Tedarikçi dönüşü', 'Seçili teklif']) },
  ...
  ROOM_SHIFTS_START_BLOCKED: { lead: templateLead('Başlatma engeli genelde vardiya zamanı, araç-sürücü ataması veya konum hazırlığı eksikliğinden olur.'), next: templateLead('Önce seçili vardiyanın atama ve canlı başlangıç durumunu kontrol edelim.'), chips: templateChipList(['Vardiya zamanı', 'Araç-sürücü ataması', 'Canlı başlangıç', 'Eksik atama']) },
  ROOM_SHIFTS_GPS_MISSING: { lead: templateLead('Konum sinyali yoksa araç bağlı olmayabilir, sürücü cihazı konum göndermiyor olabilir veya bilgi güncel değildir.'), next: templateLead('Önce araç-sürücü eşleşmesini ve son konum bilgisi zamanını kontrol edelim.'), chips: templateChipList(['Araç-sürücü eşleşmesi', 'Son konum bilgisi zamanı', 'Konum sinyali', 'Durum']) },
  ...
  ROOM_VEHICLES_NOT_VISIBLE: { lead: templateLead('Araç görünmüyorsa filtre, oda / şirket bağlamı veya araç kaydı / aktiflik durumu kontrol edilmeli.'), next: templateLead('Seçili araç varsa onun durumundan başlayalım; yoksa araç listesini kontrol edelim.'), chips: templateChipList(['Filtre', 'Son konum bilgisi zamanı', 'Araç-sürücü', 'Bağlantı durumu']) },
  ROOM_VEHICLES_CONNECTION: { lead: templateLead('Bağlantı sorunu araç-sürücü eşleşmesi, aktif vardiya veya konum sağlayıcı durumundan kaynaklanabilir.'), next: templateLead('Önce hangi aracı bağlamaya çalıştığını netleştirelim.'), chips: templateChipList(['Araç-sürücü eşleşmesi', 'Aktif vardiya', 'Konum sağlayıcı', 'Bağlantı durumu']) },
  ...
  DRIVER_CHECKIN_BLOCKED: { lead: templateLead('Check-in için doğru durak, doğru zaman ve konum uygunluğu gerekir.'), next: templateLead('Otomatik işlem yapmadan önce hangi durakta olduğunu ve konumun geldiğini kontrol edelim.'), chips: templateChipList(['Doğru durak', 'Doğru zaman', 'Konum doğrulaması', 'Otomatik işlem yok']) },
  PERSONEL_LIVE_SERVICE_MISSING: { lead: templateLead((snapshot) => `Servis görünmüyorsa genelde atanmış aktif vardiya yoktur, son GPS gelmemiştir ya da araç bağlantısı eksiktir.${selectedDetailText(snapshot) ? ` Seçili durum: ${selectedDetailText(snapshot)}.` : ''}`), next: templateLead('Önce servis saati, son GPS ve araç bağlantısını kontrol edelim.'), chips: templateChipList(['Araç nerede?', 'Son GPS ne zaman geldi?', 'Servis durumu ne?', "Sürücünün telefonundan konum sinyali geliyor mu?", 'Servis', 'Araç', 'Durak', 'Saat', 'Son GPS']) },
  PERSONEL_LIVE_VEHICLE_MISSING: { lead: templateLead((snapshot) => `Araç görünmüyorsa servis henüz başlamamış, son GPS gelmiyor veya araç bağlantısı eksik olabilir.${selectedDetailText(snapshot) ? ` Seçili durum: ${selectedDetailText(snapshot)}.` : ''}`), next: templateLead('Önce servis saati ve araç bağlantısını kontrol edelim.'), chips: templateChipList(['Araç nerede?', 'Son GPS ne zaman geldi?', 'Servis durumu ne?', "Sürücünün telefonundan konum sinyali geliyor mu?", 'Servis', 'Araç', 'Durak', 'Saat', 'Son GPS']) },
  ...
  PARENT_LIVE_LOCATION_MISSING: { lead: templateLead((snapshot) => `Konum görünmüyorsa araç konum sinyali göndermiyor, servis henüz başlamamış veya atanmış vardiya bilgisi eksik olabilir.${selectedDetailText(snapshot) ? ` Seçili durum: ${selectedDetailText(snapshot)}.` : ''}`), next: templateLead('Önce araç konumu ve servis saatinden başlayalım.'), chips: templateChipList(['Araç konumu', 'Servis saati', 'Atanmış vardiya', 'Konum sinyali durumu']) },
