...
Assert-RepoContractContainsAny -Text $route -Needles @('/payment-backbone/settings','/payment-backbone/settings/global','/payment-backbone/settings/room') -Label 'commercial core payment route exposes M82.10 setting endpoints'
...
Assert-RepoContractContainsAny -Text $backlog -Needles @("M82.10","M82.11","M83","M84","M85","M86","M87","M88","M89","M90","living route") -Label 'backlog lists M82.10'
