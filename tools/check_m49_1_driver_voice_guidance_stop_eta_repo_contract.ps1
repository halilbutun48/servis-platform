...
MustContainText $toolsReadme 'TOOLS_README_ROUTE_M49_1_VOICE_STOP_ETA_V1' 'tools readme lists m49.1 pack'
MustContainText $toolsReadme 'TOOLS_README_ROUTE_M49_1_VOICE_STOP_ETA_V1' 'tools readme lists m49.1 repo contract check'
