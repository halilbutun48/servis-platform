...
MustContainText $toolsReadme 'TOOLS_README_ROUTE_M50_RELEASE_READINESS_V1' 'tools readme lists m50 pack'
MustContainText $toolsReadme 'TOOLS_README_ROUTE_M50_RELEASE_READINESS_V1' 'tools readme lists m50 repo contract check'
