...
MustContain (Join-Path $RepoRoot "backend\scripts\m46_3_ai_copilot_quality_evidence_check.js") '["M46.3","M46.4"]' "m46.3 check accepts forward versions"
...
MustContain $service 'copilotVersion: "M46.4"' "service exposes m46.4 version"
...
MustContain $panel 'Recommended Actions' "panel renders recommended actions section"
MustContain $panel 'Consistency Checks' "panel renders consistency checks section"
MustContain $panel 'Missing Data' "panel renders missing data section"
MustContain $panel 'DecisionBadge' "panel renders decision badges"
MustContain $panel 'overallStatus' "panel renders overall status"
MustContain $panel 'actionability' "panel renders actionability"
MustContain $panel 'dataFreshness' "panel renders data freshness"
MustContain $panel 'coverage' "panel renders coverage"
