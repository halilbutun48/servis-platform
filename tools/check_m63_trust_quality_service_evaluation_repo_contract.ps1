...
Assert-RepoContractContainsAny $readme @('m63 - guven + kalite + hizmet degerlendirme','pack_m63_trust_quality_service_evaluation.ps1','post-m66 functional','m66 operasyonel reassignment','m75 green baseline','m76a-1','m77') 'root readme reflects M63 route or later official state'
...
Assert-RepoContractContainsAny $primer @('m63 - guven + kalite + hizmet degerlendirme','pack_m63_trust_quality_service_evaluation.ps1','post-m66 functional','m66 operasyonel reassignment','m75 green baseline','m76a-1','m77') 'primer ssot reflects M63 route or later official state'
Assert-RepoContractContainsAny $startpack @('m63 - guven + kalite + hizmet degerlendirme','m63 baslangic notu','post-m66 functional','pack_m66_operation_reassignment.ps1','m75 green baseline','m76a-1','m77') 'startpack reflects M63 route or later official state'
...
Assert-RepoContractContainsAny $toolsPrimer @('m63 - guven + kalite + hizmet degerlendirme','pack_m63_trust_quality_service_evaluation.ps1','post-m66 functional','m66 operasyonel reassignment','m75 green baseline','m76a-1','m77') 'tools primer reflects M63 route or later official state'
...
Assert-RepoContractContainsAny $toolsReadme @('pack_m63_trust_quality_service_evaluation.ps1','m63 green olmadan m64 acilmaz','post-m66 functional','pack_m66_operation_reassignment.ps1','m75 green baseline','m76a-1','m77') 'tools readme reflects M63 route or later official state'
