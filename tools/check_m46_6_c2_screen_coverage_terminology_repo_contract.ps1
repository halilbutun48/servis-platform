...
MustContainText $registry '/room/auth-invites' 'registry includes room auth invites option'
...
MustContainText $registry '/company/auth-invites' 'registry includes company auth invites option'
...
MustContainAny $composer @('Aynı şey değil.','Bildirim kullanıcıya giden uyarıdır.','hasNotification = /bildirim|notification/','hasAccessLink = /erişim linki|erisim linki|public link|erişim/','termComparisonReply') 'chat explains invite/log differences'
