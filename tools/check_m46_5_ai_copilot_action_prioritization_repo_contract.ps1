...
MustContain $advancedResult 'recommendedFirstAction' "advanced result card renders first action section"
MustContain $advancedResult 'calibrationNotes' "advanced result card renders calibration notes section"
MustContain $advancedResult 'priorityTone' "advanced result card renders action priority tone"
MustContain $advancedResult 'priorityScore' "advanced result card renders priority score"
MustContain $advancedResult 'whyNow' "advanced result card renders whyNow"
MustContain $advancedResult 'evidenceLinks' "advanced result card renders evidence links"
MustContain $advancedResult 'referenceLinks' "advanced result card renders reference links"
