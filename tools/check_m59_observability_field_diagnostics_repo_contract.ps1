...
MustContainAny $readme @('M59','pack_m59_observability_field_diagnostics.ps1','M65') 'root readme reflects M59 route and no-field-before-M65 rule'
MustContainAny $primer @('M59','pack_m59_observability_field_diagnostics.ps1','M65') 'primer ssot reflects new route'
...
MustContainAny $backlog @('M59','pack_m59_observability_field_diagnostics.ps1','M60') 'backlog points to M59'
MustContainAny $toolsPrimer @('M59','pack_m59_observability_field_diagnostics.ps1','M65') 'tools primer reflects M59 route'
