...
MustContainAny $readme @('README_LIVING_ROUTE_M59_M89_V1','M59','pack_m59_observability_field_diagnostics.ps1','M65','M75 green baseline','M82','M82.8','M83','M84','M85','M86','M87','M88','M89','yasayan hat') 'root readme reflects M59 route and no-field-before-M65 rule'
MustContainAny $primer @('PRIMER_LIVING_ROUTE_M59_M89_V1','M59','pack_m59_observability_field_diagnostics.ps1','M65','M75 green baseline','M82','M82.8','M83','M84','M85','M86','M87','M88','M89','yasayan hat') 'primer ssot reflects new route'
MustContainAny $startpack @('STARTPACK_LIVING_ROUTE_M59_M89_V1','M59','pack_m59_observability_field_diagnostics.ps1','Saha testi','M82','M82.8','M83','M84','M85','M86','M87','M88','M89') 'startpack reflects M59 and final field rule'
MustContainAny $checklist @('CHECKLIST_ROUTE_M59_V1','M59','pack_m59_observability_field_diagnostics.ps1','M82','M82.8','M83','M84','M85','M86','M87','M88','M89') 'checklist keeps M59 open with pack marker'
MustContainAny $backlog @('BACKLOG_ROUTE_M59_V1','M59','pack_m59_observability_field_diagnostics.ps1','M60','M76A-1','M77','M78','DB anonymize') 'backlog preserves M59 history or later canonical direction'
MustContainAny $toolsPrimer @('TOOLS_PRIMER_LIVING_ROUTE_M59_M89_V1','M59','pack_m59_observability_field_diagnostics.ps1','M65','M75 green baseline','M82','M82.8','M83','M84','M85','M86','M87','M88','M89','yasayan hat') 'tools primer reflects M59 route'
MustContainAny $toolsChecklist @('TOOLS_CHECKLIST_ROUTE_M59_V1','M59','pack_m59_observability_field_diagnostics.ps1','M82','M82.8','M83','M84','M85','M86','M87','M88','M89') 'tools checklist keeps M59 open with pack marker'
MustContainAny $toolsReadme @('TOOLS_README_ROUTE_M59_V1','pack_m59_observability_field_diagnostics.ps1','M59','M58 readiness contract') 'tools readme lists M59 pack and sequencing rule'
