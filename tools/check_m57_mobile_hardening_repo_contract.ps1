...
MustContainAny $startpack @('M57 full pack','pack_post_m41_to_m57.ps1 -RepoRoot D:\servis-platform -NoBuild','ScaffoldOnly') 'startpack lists full M57 pack and scaffold commands'
MustContainAny $readme @('M57 — Mobile Hardening','resmi green','M58 — Final Pilot Readiness') 'readme reflects M57 green and M58 next'
MustContainAny $tools @('check:m57.1','check:m57.2','check:m57.3','check:m57.4','pack_post_m41_to_m57.ps1 -RepoRoot D:\servis-platform -NoBuild') 'tools readme lists M57 checks and post-M41 pack'
