...
MustContainAny $toolsPrimer @('pack_m58_final_pilot_readiness.ps1','M58 hazirlik komutu','resmi green','M75 green baseline','M76A-1','M77','M78','DB anonymize') 'tools primer reflects M58 command and gate'
