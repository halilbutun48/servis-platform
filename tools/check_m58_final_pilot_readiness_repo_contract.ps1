...
MustContainAny $backlog @('pack_m58_final_pilot_readiness.ps1','pilot kabul formu','GO', 'NO-GO') 'backlog mentions M58 command and acceptance'
MustContainAny $startpack @('pack_m58_final_pilot_readiness.ps1','M58 hazirlik komutu','manuel pilot kabul') 'startpack lists M58 command and manual gate'
...
MustContainAny $rootReadme @('M58 — Final Pilot Readiness','pack_m58_final_pilot_readiness.ps1','manuel pilot kabul') 'root readme reflects M58 command and gate'
