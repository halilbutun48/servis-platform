...
MustContainText $toolsReadme 'TOOLS_README_ROUTE_M49_MOBILE_BETA_HARDENING_V1' 'tools readme lists m49 pack'
MustContainText $toolsReadme 'TOOLS_README_ROUTE_M49_MOBILE_BETA_HARDENING_V1' 'tools readme lists m49 repo contract check'
