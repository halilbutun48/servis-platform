...
Assert-RepoContractContainsAny $readme @('m63 green','m64 - dogal copilot katmani','pack_m64_natural_copilot_layer.ps1','post-m66 functional','m75 green baseline','m76a-1','m77') 'root readme reflects M64 route or later official state'
...
Assert-RepoContractContainsAny $primer @('m63 - guven + kalite + hizmet degerlendirme','m64 - dogal copilot katmani','pack_m64_natural_copilot_layer.ps1','post-m66 functional','m75 green baseline','m76a-1','m77') 'primer ssot reflects M64 route or later official state'
...
Assert-RepoContractContainsAny $registry @('m64 - dogal copilot katmani - green-base','m64 - dogal copilot katmani','m66 - operasyonel reassignment - functional-open','m75 green baseline','m76a-1','m77.5') 'registry lists current official M64 state'
