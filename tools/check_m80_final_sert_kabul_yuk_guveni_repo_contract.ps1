...
Assert-RepoContractContainsAny -Text $backlog -Needles @("M80","M81","M82","M89","M90","living route") -Label 'backlog points after M80 gate open'
Assert-RepoContractContainsAny -Text $registry -Needles @("M80","final sert kabul","yuk guveni","yük güveni","M81","M82","M89","living route") -Label 'registry lists active M80 meaning'
...
Assert-RepoContractContainsAny -Text $toolsPrimer -Needles @("M80","M80 final","final sert kabul","yuk guveni","yük güveni","resmi green degil","M81","M82","M89","M90","living route") -Label 'tools primer mirrors M80 gate'
...
Assert-RepoContractContainsAny -Text $m34 -Needles @('OSRM/solver opsiyonel','repoya girmez','repoya girmez') -Label 'M34 runbook explains OSRM optional profile'
