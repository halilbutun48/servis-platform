...
Assert-RepoContractContainsAny $readme @('M65 — Pilot Launch Gate','M66','tools\pack.ps1 -To 66') 'root readme reflects M65/M66 route'
...
Assert-RepoContractContainsAny $startpack @('M65 — Pilot Launch Gate','M66','tools\pack_docs_ssot.ps1') 'startpack reflects post-M65/M66 state'
...
Assert-RepoContractContainsAny $backlog @('M0-M66','cleanup','saha testi') 'backlog points to rerun after M65'
...
Assert-RepoContractContainsAny $toolsReadme @('tools\pack.ps1 -To 66','tools\pack_docs_ssot.ps1') 'tools readme lists master/docs pack'
Assert-RepoContractContainsAny $registry @('M65 - Pilot Launch Gate - green-base','M65 - Pilot Launch Gate - green','M66 - Operasyonel Reassignment - functional-open','M66 - Operasyonel Reassignment - fonksiyonel / tekrar test acik') 'registry includes M65 green and M66 open'
