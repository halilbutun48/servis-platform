...
Assert-RepoContractContainsAny $readme @('README_ROUTE_M65_V1','M65 — Pilot Launch Gate','M66','tools\pack.ps1 -To 66','tools\pack.ps1 -To 76','M75 green baseline','M82','M82.8','M83','M84','M85','M86','M87','M88','M89') 'root readme reflects M65/M66 route'
Assert-RepoContractContainsAny $projectSpec @('PROJECT_SPEC_M65_LAUNCH_GATE_V1','Pilot Launch Gate','GO / LIMITED GO / NO-GO','M59 -> M65') 'project spec reflects launch gate layer'
Assert-RepoContractContainsAny $primer @('PRIMER_ROUTE_M65_V1','M65 — Pilot Launch Gate','M66','pack_m66_operation_reassignment.ps1','M75 green baseline','M76A-1','M77','M82','M82.8','M83','M84','M85','M86','M87','M88','M89','yasayan hat') 'primer ssot reflects M65/M66 history or current living route'
Assert-RepoContractContainsAny $startpack @('STARTPACK_ROUTE_M65_V1','M65 — Pilot Launch Gate','M66','tools\pack_docs_ssot.ps1','tools\pack.ps1 -To 76','M75 green baseline','M82','M82.8','M83','M84','M85','M86','M87','M88','M89') 'startpack reflects post-M65/M66 state'
if (Test-RepoContractContainsAny -Text $checklist -Needles @('CHECKLIST_ROUTE_M65_V1','M65','M66','M82','M82.8','M83','M84','M85','M86','M87','M88','M89')) { Write-Host 'OK checklist marks M65 historical route or later living route' } else { throw 'FAIL checklist marks M65 historical route or later living route' }
Assert-RepoContractContainsAny $backlog @('BACKLOG_ROUTE_M65_V1','M0-M66','cleanup','saha testi','M76A-1','minimum normalizasyon') 'backlog points to rerun after M65'
Assert-RepoContractContainsAny $toolsPrimer @('TOOLS_PRIMER_ROUTE_M65_V1','M65 — Pilot Launch Gate','M66','fonksiyonel','M75 green baseline','M76A-1','M77','M82','M82.8','M83','M84','M85','M86','M87','M88','M89') 'tools primer reflects M65/M66 history or current living route'
...
Assert-RepoContractContainsAny $toolsReadme @('TOOLS_README_STATE_FIRST_ROUTE_V1','TOOLS_README_ROUTE_M65_V1','tools\pack.ps1 -To 66','tools\pack.ps1 -To 75','tools\pack.ps1 -To 76','tools\pack_docs_ssot.ps1','tools\pack_m77_kvkk_uyum_katmani.ps1') 'tools readme lists master/docs pack or current living master entry'
