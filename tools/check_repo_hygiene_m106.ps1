...
MustContainAny 'tools\PRIMER_SNAPSHOT.md' @('TTL_PRESETS_PARENT_PUBLIC_LINKS_V1','Veli Erişimi ve personel/öğrenci public link süre presetleri 1 gün / 1 hafta / 1 ay / 6 ay / 1 yıl.','TTL / link presetleri: `1 hafta / 1 ay / 6 ay / 1 yıl`') 'primer ttl summary sync'
MustContainAny 'docs\PRIMER_SSOT.md' @('TTL_PRESETS_PARENT_PUBLIC_LINKS_V1','1 hafta / 1 ay / 6 ay / 1 yıl') 'docs primer ttl sync'
MustContainAny 'docs\STARTPACK_V1.md' @('STARTPACK_PARENT_TTL_PRESETS_V1','Veli Erişimi presetleri: **1 gün / 1 hafta / 1 ay / 6 ay / 1 yıl**') 'startpack parent ttl sync'
