...
Current direction: **M79 green doğrulandı -> M80 kabul kapısı açıldı -> M80.1 hot panel / yük daraltma hazırlıkları**
...
2. `M80.1` altında hot panel / yük daraltma işlerini küçük ve kontrollü aç
...
## 6) İlk cümle
Repo şu an `M79`’a kadar doğrulanmış; `M80` kabul kapısı dosya seti açılmış durumdadır. Bir sonraki doğru iş, mevcut repo gerçeğini bozmadan `M80.1` altında hot panel ve yük daraltma işlerini küçük ve kontrollü ilerletmektir.
