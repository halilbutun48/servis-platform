...
- Post-M41 pack scripts self-only calisir; tam M42 -> M56 green hatti ve M57 scaffold kontrolu `tools\pack_post_m41_to_m57.ps1` ile disaridan orkestre edilir.
...
- Siradaki ana urun isi `M57 — Mobile Hardening` olarak devam eder; `M57.1 foreground GPS publish` implementasyon packi artik repoda vardir.
...
- `tools\pack_m57_mobile_hardening.ps1 -RepoRoot D:\servis-platform`
- `tools\pack_m57_mobile_hardening.ps1 -RepoRoot D:\servis-platform -ScaffoldOnly`
- Bu komut mevcut mobil temel + M57 runbook/check dosyalarini dogrular.
