...
const SHARED = [
  ...
  { id: 9002, path: "/shared/logs", label: "İşlem kayıtlarını dışa aktar" },
...
const REGISTRY = {
  ROOM: [
    ...
    { id: 1109, path: "/room/checkin", label: "Biniş kayıtları" },
  ...
  COMPANY: [
    ...
    { id: 2104, path: "/company/access-links", label: "Personel bağlantıları" },
    { id: 2105, path: "/company/copilot", label: COPILOT_MENU_LABEL },
    { id: 2106, path: "/company/hub", label: hubLabelForKind("COMPANY") },
    { id: 2107, path: "/company/checkin", label: "Biniş kayıtları" },
  ...
  SCHOOL: [
    ...
    { id: 2204, path: "/school/access-links", label: "Öğrenci bağlantıları" },
    { id: 2205, path: "/school/copilot", label: COPILOT_MENU_LABEL },
    { id: 2206, path: "/school/hub", label: hubLabelForKind("SCHOOL") },
    { id: 2207, path: "/school/checkin", label: "Biniş kayıtları" },
  ...
  ORGANIZATION: [
    ...
    { id: 2305, path: "/organization/access-links", label: "Personel bağlantıları" },
    ...
    { id: 2308, path: "/organization/checkin", label: "Biniş kayıtları" },
  ...
  DRIVER: [
    ...
    { id: 3104, path: "/driver/checkin", label: "Biniş kaydı" },
  ...
  SUPER_ADMIN: [
    ...
    { id: 6120, path: "/superadmin/telematics", label: "Konum veri sağlayıcıları" },
    ...
    { id: 6115, path: "/superadmin/logexport", label: "İşlem kayıtlarını dışa aktar" },
    { id: 6116, path: "/superadmin/natural-copilot", label: "Doğal yardımcı" },
