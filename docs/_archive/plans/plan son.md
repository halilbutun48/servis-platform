...
Not: Eğer hâlihazırda GET /api/shifts/:id ve GET /api/shifts/:id/stops gibi endpointlerin varsa, route-preview sadece `people + assignments + stops` tek response olarak birleştiren ince bir wrapper da olabilir.
