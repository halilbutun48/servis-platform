...
- premium smoke: PASS 64 / PASS- 18 / UX-FIX 0 / BLOCKER 0 / AUTH-BLOCKED 0 / NOT-FOUND 0
...
- premium smoke PASS- `18` are documented in `docs/UX_SMOKE_PASS_MINUS_EVIDENCE_01.md`.
