...
- Canonical milestone: `SEFER-ABI-TURKISH-USER-FACING-TERMINOLOGY-AUDIT-01`
...
- `ETA → tahmini varış süresi`, `Son GPS` için `son konum bilgisi`, `GPS → konum sinyali / konum bilgisi`, `safe alternative` için `önce şunu kontrol et` çizgisini korur.
