...
- Toplam package script entry: `390`
- Toplam executable tracked file: `1200`
- Combined registry row: `1590`
- Root/backend/web/mobile package dağılımı: root `233`, backend `760`, web `93`, mobile `201`
...
- Eski sistem term eşleşmesi: `322`
...
| root:check:copilotoperationhealthengine01 | package.json | root | node backend/scripts/copilot_operation_health_engine_01_check.js | core | ACTIVE_CORE |  | COPILOT-OPERATION-HEALTH-ENGINE-01 |  | Breaks canonical verification chain |  |
