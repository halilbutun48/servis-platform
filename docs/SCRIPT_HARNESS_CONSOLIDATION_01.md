...
- Toplam package script entry: `478`
- Toplam executable tracked file: `1363`
- Combined registry row: `1841`
- Root/backend/web/mobile package dağılımı: root `297`, backend `939`, web `101`, mobile `201`
...
- Room profitability milestone: `ROOM-PROFITABILITY-AND-QUOTE-FLOOR-01`
- Room profitability check: `check:roomprofitabilityandquotefloor01`
- Room profitability root check: `root:check:roomprofitabilityandquotefloor01`
- Room profitability docs: `docs/ROOM_PROFITABILITY_AND_QUOTE_FLOOR_01.md`
...
- Eski sistem term eşleşmesi: `392`
...
| root:check:guardv2standardization01 | package.json | root | node backend/scripts/guard_v2_standardization_01_check.js | review | NEEDS_REVIEW |  | ROOT-CHECK-GUARDV-2-STANDARDIZATION-01 |  | Owner or chain unclear |  |
...
| root:smoke:seferabicharactersafesnappolish01 | package.json | root | node backend/scripts/sefer_abi_character_animation_safe_snap_polish_01_browser.mjs | review | NEEDS_REVIEW |  | ROOT-SMOKE-SEFERABICHARACTERSAFESNAPPOLISH-01 |  | Owner or chain unclear |  |
...
| root:check:rolebasedsimplenavigationandtaskhome01 | package.json | root | node backend/scripts/role_based_simple_navigation_and_task_home_01_check.js | review | NEEDS_REVIEW |  | ROOT-CHECK-ROLEBASEDSIMPLENAVIGATIONANDTASKHOME-01 |  | Owner or chain unclear |  |
...
| root:smoke:rolebasedsimplenavigationandtaskhome01 | package.json | root | node backend/scripts/role_based_simple_navigation_and_task_home_01_browser.mjs | review | NEEDS_REVIEW |  | ROOT-SMOKE-ROLEBASEDSIMPLENAVIGATIONANDTASKHOME-01 |  | Owner or chain unclear |  |
...
| root:check:core-regression | package.json | root | node backend/scripts/run_guard_regression_chain.js --tier core | review | NEEDS_REVIEW |  | ROOT-CHECK-CORE-REGRESSION |  | Owner or chain unclear |  |
| root:check:extended-regression | package.json | root | node backend/scripts/run_guard_regression_chain.js --tier extended | review | NEEDS_REVIEW |  | ROOT-CHECK-EXTENDED-REGRESSION |  | Owner or chain unclear |  |
| root:check:release-regression | package.json | root | node backend/scripts/run_guard_regression_chain.js --tier release | review | NEEDS_REVIEW |  | ROOT-CHECK-RELEASE-REGRESSION |  | Owner or chain unclear |  |
...
| backend:generate:documentationregistryv1 | backend/package.json | backend | node scripts/generate_documentation_registry_v1.js --write | review | NEEDS_REVIEW |  | BACKEND-GENERATE-DOCUMENTATIONREGISTRYV-1 |  | Owner or chain unclear |  |
| backend:check:documentationregistryv1 | backend/package.json | backend | node scripts/documentation_registry_v1_check.js | review | NEEDS_REVIEW |  | BACKEND-CHECK-DOCUMENTATIONREGISTRYV-1 |  | Owner or chain unclear |  |
| backend:check:changeimpactregistryv1 | backend/package.json | backend | node scripts/change_impact_registry_v1_check.js | review | NEEDS_REVIEW |  | BACKEND-CHECK-CHANGEIMPACTREGISTRYV-1 |  | Owner or chain unclear |  |
| backend:check:checkownershipregistryv1 | backend/package.json | backend | node scripts/check_ownership_registry_v1_check.js | review | NEEDS_REVIEW |  | BACKEND-CHECK-CHECKOWNERSHIPREGISTRYV-1 |  | Owner or chain unclear |  |
| backend:check:impactawarevalidationplannerv1 | backend/package.json | backend | node scripts/impact_aware_validation_planner_v1_check.js | review | NEEDS_REVIEW |  | BACKEND-CHECK-IMPACTAWAREVALIDATIONPLANNERV-1 |  | Owner or chain unclear |  |
| backend:check:impactawarevalidationv1 | backend/package.json | backend | node scripts/impact_aware_validation_v1_check.js | review | NEEDS_REVIEW |  | BACKEND-CHECK-IMPACTAWAREVALIDATIONV-1 |  | Owner or chain unclear |  |
| backend:run:impactawarevalidationv1 | backend/package.json | backend | node scripts/run_impact_aware_validation_v1.js | review | NEEDS_REVIEW |  | BACKEND-RUN-IMPACTAWAREVALIDATIONV-1 |  | Owner or chain unclear |  |
...
| seed.js | backend/prisma/seed.js | backend | backend:bootstrap, backend:seed | review | NEEDS_REVIEW |  | SEED |  | Owner or chain unclear |  |
...
| operational_cost_model_01_expansion.js | backend/scripts/operational_cost_model_01_expansion.js | backend |  | review | NEEDS_REVIEW |  | OPERATIONAL-COST-MODEL-01-EXPANSION |  | Owner or chain unclear |  |
...
| project_wide_turkish_language_terminology_audit_01_browser.mjs | backend/scripts/project_wide_turkish_language_terminology_audit_01_browser.mjs | backend | root:smoke:projectwideturkishterminology01 | review | NEEDS_REVIEW |  | PROJECT-WIDE-TURKISH-LANGUAGE-TERMINOLOGY-AUDIT-01-BROWSER |  | Owner or chain unclear |  |
| project_wide_turkish_language_terminology_audit_01_check.js | backend/scripts/project_wide_turkish_language_terminology_audit_01_check.js | backend | root:check:projectwideturkishterminology01 | review | NEEDS_REVIEW |  | PROJECT-WIDE-TURKISH-LANGUAGE-TERMINOLOGY-AUDIT-01-CHECK |  | Owner or chain unclear |  |
...
| sefer_abi_character_animation_safe_snap_polish_01_browser.mjs | backend/scripts/sefer_abi_character_animation_safe_snap_polish_01_browser.mjs | backend | root:smoke:seferabicharactersafesnappolish01 | review | NEEDS_REVIEW |  | SEFER-ABI-CHARACTER-ANIMATION-SAFE-SNAP-POLISH-01-BROWSER |  | Owner or chain unclear |  |
...
| registry.js | backend/src/ai/jobGuide/registry.js | backend | backend:check:changeimpactregistryv1, backend:check:checkownershipregistryv1, backend:check:documentationregistryv1, backend:generate:documentationregistryv1 | review | NEEDS_REVIEW |  | REGISTRY |  | Owner or chain unclear |  |
...
| audit.js | backend/src/audit.js | backend | root:accept:projectgapreadiness01, root:audit:repo, root:check:ai03bparaphraseintentaudit01, root:check:ai03bsemanticvisibleaudit01, root:check:auditlogandapprovaltrace01, root:check:cop04b, root:check:onboardingreviewfinal01, root:check:onboardingreviewfinalaudit01, root:check:productflowbuttonaudit01, root:check:projectgapreadiness01, root:check:projectwideturkishterminology01, root:check:testqualityandflakeaudit01, root:check:uiactionwiringaudit01, root:check:uxallpanelsrealityaudit01, root:check:uxlivepanelsmokeaudit01, root:check:uxmobileallrolespanelaudit01, root:check:uxpanelreality02c, root:check:uxsuperadminauditpanel01, root:smoke:productflowbuttonaudit01, root:smoke:projectgapreadiness01, root:smoke:projectwideturkishterminology01, root:smoke:uxallpanelsrealityaudit01, root:smoke:uxmobileallrolespanelaudit01 | product-extensions | NEEDS_REVIEW |  | AUDIT |  | Owner or chain unclear |  |
...
| ai.js | backend/src/routes/ai.js | backend | backend:repo:check, backend:repo:check:chain, mobile:check:m81.2b, mobile:check:m96a, root:check:ai03bparaphraseintentaudit01, root:check:ai03bsemanticvisibleaudit01, root:check:ai03bsemanticvisiblelivematrix01, root:check:airesponsesemanticqualitygate01, root:check:cop03b, root:check:copilotairoadmap01, root:check:core-regression, root:check:extended-regression, root:check:hotfilesplitaichatcomposers01, root:check:m99kvkk01, root:check:pay01c, root:check:product-extensions, root:check:release-regression, root:check:roadmaplockaimarketplace01, root:check:uxpremiumcriticalfixagreementsdetail01, root:check:verifychain01, root:verify:closure, root:verify:docs, root:verify:hot, root:verify:repo, root:verify:web-contract | verify:repo | NEEDS_REVIEW |  | AI |  | Owner or chain unclear |  |
...
| copilotSharedState.js | web/src/utils/copilotSharedState.js | web |  | review | NEEDS_REVIEW |  | COPILOT-SHARED-STATE |  | Owner or chain unclear |  |
...
| navigation.js | web/src/utils/navigation.js | web | mobile:check:m95e22b, root:check:rolebasedsimplenavigationandtaskhome01, root:smoke:rolebasedsimplenavigationandtaskhome01 | review | NEEDS_REVIEW |  | NAVIGATION |  | Owner or chain unclear |  |
...
| roleNavigation.js | web/src/utils/roleNavigation.js | web |  | review | NEEDS_REVIEW |  | ROLE-NAVIGATION |  | Owner or chain unclear |  |
...
| terminology.js | web/src/utils/terminology.js | web | root:check:projectwideturkishterminology01, root:check:seferabiturkishterminology01, root:smoke:projectwideturkishterminology01 | review | NEEDS_REVIEW |  | TERMINOLOGY |  | Owner or chain unclear |  |
...
| navigation.js | mobile/src/lib/navigation.js | mobile | mobile:check:m95e22b, root:check:rolebasedsimplenavigationandtaskhome01, root:smoke:rolebasedsimplenavigationandtaskhome01 | review | NEEDS_REVIEW |  | NAVIGATION |  | Owner or chain unclear |  |
...
| backend/scripts/cache_coalescing_and_backoff_01_check.js | Hub | NEEDS_REVIEW |
...
| backend/scripts/copilot_human_approval_01_check.js | OperationProof | NEEDS_REVIEW |
| backend/scripts/copilot_reasoning_answer_composer_01_check.js | Yer | NEEDS_REVIEW |
| backend/scripts/copilot_rfq_prep_01_check.js | Hub | NEEDS_REVIEW |
