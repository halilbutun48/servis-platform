...
- `COST-SCENARIO-FORECAST-AND-SAVINGS-01` `check:costscenarioforecastandsavings01`, `docs/COST_SCENARIO_FORECAST_AND_SAVINGS_01.md`, `backend/src/finance/costScenarioForecast.js` ve `backend/src/routes/costScenario.js` ile takip edilir; operational cost model tek hesap sahibidir, sonuç ephemeral preview'dır.
