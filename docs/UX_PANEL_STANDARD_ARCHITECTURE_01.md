...
| `web/src/panels/company/WorkflowPanel.jsx` | Company | Var | Var | Var | Net | Var | Var | Var | Risk | UX-FIX |
...
| `web/src/panels/room/OffersPanel.jsx` | Room | Var | Yok | Var | Net | Yok | Var | Yok | Risk | UX-FIX |
