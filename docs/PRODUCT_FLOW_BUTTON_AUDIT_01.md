...
- Parent canlı yüzeyinde fallback/no-vehicle modunda request ve refresh görünür kalır; çocuk/navigasyon/no-show butonları disabled placeholder olarak görünür.
