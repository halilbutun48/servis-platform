# SCRIPT KILAVUZU — MILESTONE HARITASI V1
...
### Ana amaç
Ödeme mimarisini şimdi kurmak, ama tam para akışını sonra açmak.
...
- agreement anında payment/commission snapshot
...
### Ana amaç
Ödeme modu ve komisyon oranını merkezi yönetmek.

### Ne yapar?
- Super Admin ödeme modu seçer
- komisyon oranı sade girilir: `1`, `2`, `3` → yüzde
...
### Ana amaç
Ödeme tam açılmadan önce bile agreement üzerinde ticari hazırlığı görünür kılmak.
...
8. **M82–M86:** önce çekirdek kalite borcu, sonra dormant payment, sonra saha, sonra gelir modeli aktivasyonu  
