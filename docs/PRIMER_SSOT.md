...
- `OP-01` OperationProof / ServiceProof merkezi kanıt omurgası closed-readonly; `OP-02` manuel operatör kanıt notu katmanı active; `M99-KVKK-01` ve `M99-UX-01` kararları korunur.
