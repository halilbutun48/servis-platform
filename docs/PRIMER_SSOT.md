...
- `COPILOT-OFFER-RECOMMENDATION-01` negotiation assist sonrası gelen read-only recommendation companion milestone'dır; supplier selection, offer accept/reject, supplier contact, RFQ send ve provider credential kullanımını açmaz.
