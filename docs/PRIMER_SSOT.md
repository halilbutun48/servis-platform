...
- Finansal Operasyon ve Maliyet Yönetimi bloğu COPILOT-ACTION-PREP-01 sonrasında planlanır; mevcut dynamic savings, hakediş önizleme, kalite/payment bridge, payment preview, CSV export ve Sefer Abi cost cevapları yeniden kullanılır; full muhasebe/e-Fatura/e-Defter/vergi programı değildir; ROOM ve COMPANY yüzeyleri RBAC ile bağlanır.
