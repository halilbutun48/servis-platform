...
- `COPILOT-DISPATCH-ACTION-PREP-01` shift sonrası gelen read-only dispatch prep companion milestone'dır; route apply ve dispatch apply öncesi güvenli hazırlık çizgisini taşır.
