...
- Bu değişiklik yapılırsa **yeni bir tag** ile sabitlenmesi önerilir (mevcut `v1-m14-green.2` referansını kirletmemek için).

---

## 10) Şu anki durum (M14 GREEN kapsamında doğrulananlar)
