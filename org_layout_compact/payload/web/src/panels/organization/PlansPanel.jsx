...
function StopCard({ row, index, onChange, onRemove, onMoveUp, onMoveDown, total }) {
  return (
    <div className="card" style={{ padding: 12 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "minmax(0,1.1fr) minmax(0,1.4fr) 110px", gap: 8, marginBottom: 8 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "minmax(0,.9fr) minmax(0,.9fr) 130px 130px minmax(0,1.1fr)", gap: 8 }}>
...
export default function OrganizationPlansPanel() {
  ...
  return (
    <div className="wrap" style={{ maxWidth: "none", width: "100%", paddingRight: 12 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "300px minmax(560px, 1fr) 280px", gap: 12, marginTop: 12, alignItems: "start", width: "100%" }}>
        ...
        <div className="card">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "minmax(220px,1.5fr) 150px 120px 120px", gap: 8, marginBottom: 8 }}>
