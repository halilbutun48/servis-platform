...
## M80 başlangıç yaklaşımı
Bu tur için doğru sıra:
1. mevcut repo gerçeğine göre markdown/SSOT hizasını düzelt
2. eski milestone anlam çakışmalarını görünür hale getir
3. M80 için küçük, kontrollü başlangıç omurgasını hazırlamaya geç

## Kısa karar cümlesi
Repo şu anda “M79’a kadar doğrulanmış, ama M78.x compatibility marker’ları içeride korunmuş” bir durumdadır. Bundan sonraki doğru iş, ürün davranışını bozmadan `M80` hattını küçük ve kontrollü başlatmaktır.
