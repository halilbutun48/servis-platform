  ...
  return (
    <div className="wrap">
      <div className="card">
        ...
        <div className="title" style={{ marginTop: 6 }}>{isRoom ? "Sürücü Giriş Davetleri" : "Personel Giriş Davetleri"}</div>
        <div className="muted">Vardis üzerinde doğrulanmış Google hesabıyla giriş aç. Invite yoksa Google login reddedilir.</div>
      </div>
