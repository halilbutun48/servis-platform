...
$backupRoot = Join-Path $RepoRoot ("_overlay_backup_m80_3_georeview_shifts_son_giris_yuku_" + $stamp)
New-Item -ItemType Directory -Force -Path $backupRoot | Out-Null

Write-Host ''
Write-Host '=== APPLY OVERLAY M80.3 GEOREVIEW + SHIFTS SON GIRIS YUKU ==='
...
Write-Host '.\tools\pack_m80_2_agreements_shifts_giris_yuku.ps1 -RepoRoot D:\servis-platform'
Write-Host '.\tools\pack_m80_3_georeview_shifts_son_giris_yuku.ps1 -RepoRoot D:\servis-platform'
