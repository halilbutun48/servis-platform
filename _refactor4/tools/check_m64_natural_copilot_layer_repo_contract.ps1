...
Assert-RepoContractContainsAny $startpack @('m64 - dogal copilot katmani','m64 baslangic notu','m64 bitmeden m65','post-m66 functional') 'startpack reflects M64 opening or later official state'
...
Assert-RepoContractContainsAny $toolsPrimer @('m64 - dogal copilot katmani','pack_m64_natural_copilot_layer.ps1','post-m66 functional') 'tools primer reflects M64 route or later official state'
...
Assert-RepoContractContainsAny $toolsReadme @('m64 - dogal copilot katmani','pack_m64_natural_copilot_layer.ps1','post-m66 functional') 'tools readme reflects M64 route or later official state'
