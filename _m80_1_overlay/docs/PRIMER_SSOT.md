...
## Kısa karar cümlesi
Repo şu anda “M79’a kadar doğrulanmış, ama M78.x compatibility marker’ları içeride korunmuş; M80 kabul kapısı açılmış” bir durumdadır. Bundan sonraki doğru iş, ürün davranışını bozmadan `M80.1` altında yük sıcak noktalarını kontrollü daraltmaktır.
