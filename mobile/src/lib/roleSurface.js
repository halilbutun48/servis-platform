...
const ROLE_SURFACES = Object.freeze({
  ...
  COMPANY: {
    ...
    emptyTitle: 'Bugün şirket için canlı özet bulunmuyor.',
    emptyText: 'Canlı şirket özeti aktif veri geldiğinde görünür.',
    actionLabel: 'Yenile',
  ...
  ROOM: {
    ...
    mode: 'overview',
    title: 'Oda Özeti',
    subtitle: 'Oda operasyonunun kısa özeti ve canlı durum burada görünür.',
    emptyTitle: 'Bugün oda için canlı özet bulunmuyor.',
    emptyText: 'Canlı oda özeti aktif veri geldiğinde görünür.',
    actionLabel: 'Yenile',
    actionNote: 'Ayrıntılı yönetim web panelinde açılır.',
    note: 'Oda operasyonu mobilde hafif özet olarak açılır.',
  },
  SUPER_ADMIN: {
