...
must(today, 'Ortam asamasi', 'today screen still shows env stage guidance');
must(today, 'Kabul ozeti', 'today screen still shows acceptance summary');
must(live, 'Gelişmiş durum', 'live screen shows diagnostics card');
must(live, 'Ortam', 'live screen shows release env state');
must(live, 'Yayin durumu', 'live screen shows release status');
