...
must(has(card, 'Sürücü mola / müsaitlik'), 'availability card shows driver availability title');
must(has(card, 'Hazır bekleme tercihi cihazda saklanır.'), 'availability card explains local availability storage');
